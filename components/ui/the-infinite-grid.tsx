...
export const Component = () => {
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none relative z-10 mx-auto flex w-full max-w-6xl flex-col items-center gap-8 px-5 pt-20 lg:px-12">
        <h1 className="text-center text-4xl font-black uppercase tracking-normal text-foreground drop-shadow-sm sm:text-5xl md:text-7xl">
          FURKAN NACAKCI
        </h1>

        <div className="grid w-full items-center gap-8 lg:grid-cols-[1fr_0.78fr]">
          ...
          <div className="mx-auto flex w-full max-w-[270px] flex-col items-center gap-4 justify-self-center sm:max-w-[330px] lg:max-w-[390px]">
            <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg border border-border bg-card shadow-2xl shadow-black/10">
              <img
                src={profilePhotoUrl}
                alt="Furkan Nacakcı"
